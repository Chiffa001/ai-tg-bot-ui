...
import { getChatPreviewMessages } from "@/modules/welcome/constants/chat-preview-messages";
...
export const LeftVisualSection = () => {
  const t = useTranslations("welcome.chat");
  const chatPreviewMessages = getChatPreviewMessages(t);
